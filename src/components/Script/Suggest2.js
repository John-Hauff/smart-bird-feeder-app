...
const getAllDescriptions = (chord1, chord2, chord3, chord4, chord_position, key, mode) => {
	...
	console.log('chord1 '+chord1+', chord2 '+chord2+', chord3 '+chord3+', chord4 '+chord4)
	console.log('in Sug, key is '+key+', mode is '+mode)
